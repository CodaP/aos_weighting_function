...
\abstract{In this paper the construction of a microwave radiative transfer model is presented.  Atmospheric weighting functions are derived and graphically depicted. Experiments are conducted on model parameters such as surface emissivity and elevation angle. Each experimental result compares the effects of the parameters on two locations, one tropical and the other Arctic.} 
